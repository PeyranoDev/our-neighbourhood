...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250609031715_TowerDescriptionMigration")]
    partial class TowerDescriptionMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AmenityAvailability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.AppSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Tower", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.UserTower", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Amenity", b =>
                {
                    b.HasOne("Domain.Entities.Tower", "Tower")
                        .WithMany("Amenities")
            ...
            modelBuilder.Entity("Domain.Entities.AppSettings", b =>
                {
                    b.HasOne("Domain.Entities.Tower", "Tower")
                        .WithOne("Settings")
                        .HasForeignKey("Domain.Entities.AppSettings", "TowerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Domain.Entities.ColorPalleteList", "Colors", b1 =>
                        {
